...
const patientsData = [
  ...
  { uhid: 'UHID-23101', name: 'Pooja Iyer', age: 25, gender: 'Female', phone: '+91 3322110099', lastVisit: '21 Jun 2026', doctor: 'Dr. Riya Sharma', status: 'Active', tags: ['Allergy: Penicillin'] },
  { uhid: 'UHID-23102', name: 'Deepak Chopra', age: 55, gender: 'Male', phone: '+91 2211009988', lastVisit: '14 May 2026', doctor: 'Dr. Vikram Sethi', status: 'Active', tags: ['VIP'] },
  { uhid: 'UHID-23103', name: 'Anita Dongre', age: 39, gender: 'Female', phone: '+91 1100998877', lastVisit: '08 Jun 2026', doctor: 'Dr. Riya Sharma', status: 'Active', tags: [] },
  { uhid: 'UHID-23104', name: 'Manish Malhotra', age: 42, gender: 'Male', phone: '+91 9900887766', lastVisit: '17 Jun 2026', doctor: 'Dr. Alok Mehta', status: 'Inactive', tags: [] },
  { uhid: 'UHID-23105', name: 'Sabyasachi M.', age: 35, gender: 'Male', phone: '+91 8899776655', lastVisit: '22 Jun 2026', doctor: 'Dr. Sarah Thomas', status: 'Active', tags: [] },
  { uhid: 'UHID-23106', name: 'Arjun Kapoor', age: 27, gender: 'Male', phone: '+91 7788665544', lastVisit: '03 Jun 2026', doctor: 'Dr. Vikram Sethi', status: 'Active', tags: [] },
  { uhid: 'UHID-23107', name: 'Meera Rajput', age: 33, gender: 'Female', phone: '+91 6677554433', lastVisit: '11 May 2026', doctor: 'Dr. Riya Sharma', status: 'Inactive', tags: ['Maternity'] },
  { uhid: 'UHID-23108', name: 'Kunal Nayyar', age: 40, gender: 'Male', phone: '+91 5566443322', lastVisit: '20 Jun 2026', doctor: 'Dr. Alok Mehta', status: 'Active', tags: [] },
];
    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-20">
      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden flex flex-col">
        ...
        <div className="p-4 border-t border-slate-200 bg-slate-50 flex items-center justify-between text-sm text-slate-600">
          <div>
            Showing <span className="font-semibold text-slate-900">1</span> to <span className="font-semibold text-slate-900">18</span> of <span className="font-semibold text-slate-900">5,432</span> patients
          </div>
          <div className="flex items-center gap-1">
            ...
            <button className="px-3 py-1 hover:bg-slate-200 rounded transition-colors">301</button>
